...
def find_duplicates(nums):
    num_counts = {}
    for num in nums:
        num_counts[num] = num_counts.get(num, 0) + 1 # num_counts.get(num, 0) - means if num exists in the dict it will get (i.e., the count of occurrences of num so far). else it would return 0 becuase of 0.
